...
2. Update the [README.md](/README.md) with details of changes to the
   interface, this includes new environment variables, exposed ports,
   useful file locations and container parameters.
3. Increase the version numbers in any examples files and the
   [README.md](/README.md) to the new version that this Pull Request
   would represent. The versioning scheme we use is
...
4. You may merge the Pull Request in once you have the sign-off of one
   ...
   request the owner to merge it for you.
...
[tdomingues@myges.fr](mailto:tdomingues@myges.fr).
